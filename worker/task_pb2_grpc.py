...
class WorkerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeData = channel.unary_unary(
                '/Worker/AnalyzeData',
                request_serializer=task__pb2.AnalysisRequest.SerializeToString,
                response_deserializer=task__pb2.AnalysisResponse.FromString,
...
def add_WorkerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AnalyzeData': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=task__pb2.AnalysisRequest.FromString,
                    response_serializer=task__pb2.AnalysisResponse.SerializeToString,
            ),
    }
...
class Worker(object):
    ...
    def AnalyzeData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Worker/AnalyzeData',
            task__pb2.AnalysisRequest.SerializeToString,
            task__pb2.AnalysisResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
